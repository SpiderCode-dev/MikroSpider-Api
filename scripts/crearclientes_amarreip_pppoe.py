...
##FUNCION PARA CREAR CLIENTES IP FIJA PPPoE + QUEUE ESTÁTICAS + ARP MARK STATIC
...
def crearclientes_ipstatic_pppoe(ip_host, user, pwd, port, nombres, ips, macaddress, interfaz, plan, localip, user_pppoe, pwd_pppoe, perfil_pppoe):
